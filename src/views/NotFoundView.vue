<template>
  <div class="container">
    ...
    <div class="text">
      ...
      <h3>
        Page Not Found - lets take you <RouterLink to="/">HOME</RouterLink>
      </h3>
      <p>
        404 template copied from
        <a href="https://codepen.io/namratapdr/pen/yLOgREo">Here</a>
      </p>
    </div>
  </div>
  <!-- 404 template copied from here -->
</template>
<style scoped>
body {
  background: #000;
